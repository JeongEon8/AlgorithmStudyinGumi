...
| 아이디                                                      | 목표                                |
| ----------------------------------------------------------- | ----------------------------------- |
| [김정언(JeongEon)](https://github.com/JeongEon8)            | 백준 실버 이상 6개                  |
| [양성원(YSW-Yang)](https://github.com/YSW-Yang)             | 백준 실버 이상 6개                  |
| [이상혁(hyuksanglee)](https://github.com/hyuksanglee)       | 백준 실버 이상 6개                  |
| [이승지(bmlsj)](https://github.com/bmlsj)                   | 백준 실버 이상 6개                  |
| [정유진(breadbirds)](https://github.com/breadbirds)         | 백준 실버 이상 6개                  |
| [정찬우(Jhanoo)](https://github.com/Jhanoo)                 | 백준 골드 이상 4개                  |
| [이서현(kizizip)](https://github.com/kizizip)               | (취업자배려전형)                    |
| [장홍준(ajang369)](https://github.com/ajang369)             | (취업자배려전형)                    |
| [한아영(hanayoung)](https://github.com/hanayoung)           | (취업자배려전형) 백준 실버 이상 4개   |
| [황선혁(HwangSeonHyeok)](https://github.com/HwangSeonHyeok) | (취업자배려전형) 23일 컴백           |
